 ...
 * @return             info_code that is set after the call  // TODO: different return value?
 */
KR_EXPORT
int kr_request_set_extended_error(struct kr_request *request, int info_code, const char *extra_text);  // TODO perhaps shorten to kr_request_set_ede()?
